...
public interface UserService {
	...
	User verifyLogin(String emial, String pw) throws Exception;
	JSONObject register(User user) throws Exception;
	User findById(int id) throws Exception;
	Object find(Class entityClass, int id) throws Exception;
...
//	boolean findByNickName(String nickName) throws Exception;
