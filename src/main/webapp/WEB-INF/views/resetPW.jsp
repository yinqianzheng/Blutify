        ...
        <div class="form">
          ...
          <main>
            <form id="resetPWform" name="resetPW" action="processResetPW" method="post">
              <div class="input">
                <label for="resetpassword" id="email_label">Password</label>
                <input class="label_pop" type="password" name="newPassword" id="resetpassword">
              </div>

              <div class="input">
                <label for="password" id="password_label">Confirm Password</label>
                <input class="label_pop" type="password"  id="resetpasswordConfirm" name="passwordConfirm" >
              </div>
            </form>
          </main>
        </div>
        <button type="button" onclick="resetPWFunction()">Reset</button>
      </div>
...
<script>
	function resetPWFunction()
	{
		...
		if(newPW == newPWConfirm)
		{
			...
			{
			document.getElementById("resetpasswordConfirm").style.background = "red";
