...
<div class="content">
  <div class="mainInfo">
    <h1>Blue</h1>
      ...
      <div class="aboutMe" style="width: 250%;">
        ...
        <ul class="webStats" >
          <li><span>Total # of Artists:</span> 345,428</li>
          <li><span>Total # of Songs:</span> 2,350</li>
          <li><span>Total # of Songs Played</span> 2,350</li>
        </ul>
      </div>
  ...
  <div class="matchStats">
    <div class="backgroundText">GENNR</div>
  ...
  <div class="col" style="width: 100%; height: 100px; margin-top: -10%">
    <h2>Profit</h2>
     <ul class="profitStats">
      <li><span>From subscript:</span> 345,428</li>
      <li><span>From ads:</span> 2,350</li>
   <li><span>Total Profit:</span> 2,350</li>
    </ul>
    <div class="resizing">
      <canvas id="champData"/>
    </div>
    ...
    <div>
      <h2 style="position: relative; margin-left: -5px;">Profit</h2>
     <ul class="songStats">
      <li><span>From subscript:</span> 345,428</li>
      <li><span>From ads:</span> 2,350</li>
      <li><span>From subscript:</span> 345,428</li>
...
<div class="col" style="width: 15%;">
  ...
  <div class="col middle" style="width: 25%;">
    ...
    <label style="color: gray; margin-top: 30px; position: absolute;">General:</label>
    <label style="color: gray; margin-top: 60px; position: absolute;">Premium:</label>
